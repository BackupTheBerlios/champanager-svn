package championship.manager.domain;

import championship.manager.util.NameComparator;
import championship.manager.util.GamePositionComparator;
...
public class Championship {
    ...
    private Boolean intermediateStage;
    private Boolean quarterFinal;
    private Boolean thirdPlaceGame;
    private Integer qualifyingTeams;
    private Integer intermediateStageGroupCount;
    ...
    public Set<Game> getGames(Set<String> groupNames) {
